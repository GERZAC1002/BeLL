...
Das als Opensource verfügbare Programm QGIS ist für Laien recht unübersichtlich und überfordert durch zu gorßen Funktionsumfang. Bei der Anwendung handelt es sich auch nicht um eine Webanwendung, wodurch der Nutzer zusätzlich Software herunterladen muss.
...
Die Karte wird dabei erstellt und hat als Mittlepunkt die Stadt Leipzig(Längengrad: 51.339\textdegree  Nord, Breitengrad: 12.381\textdegree  Ost, ). Die Ansicht ist standardmäßig auf eine Zoomstufe von 12 eingestellt, da man so die gesamte Stadt und das Umland sehen kann.
