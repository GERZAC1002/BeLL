...
\setcounter{page}{1}
\chapter {Einleitung}
In Zeiten des Internets\todo{"Zeiten des Internets" finde ich zu allgemein. Das Internet gibt es ja nun schon ziemlich lange} verlieren lokal installierte Anwendungen zunehmend an Bedeutung und Webanwendungen werden immer beliebter.\todo{Behauptungen immer belegen.}
Deshalb habe ich im Rahmen meiner Besonderen Lernleistung eine Webanwendung erstellt.
...
Diese Anwendung soll\todo{hier ist die Anwendung noch nicht da} aus gegebenen Standorten und der Häufigkeit des Ansteuerns dieser Orte eine optimale Position für den eigenen Standort liefern, um den Fahrtweg zu reduzieren.
Die Anwendung greift\todo{im nächsten Satz wird die Anwendung adressiert, als wäre sie schon vorhanden, auf Konsistenz achten. Ich schlage vor, immer wie hier von der Anwendung zu sprechen, als wäre sie schon da.} auf Online Kartendienste wie Google Maps oder Open Street Map zurück.
Dies kann vor allem für Online Apotheken oder generell für den Online Handel sinnvoll sein, um einen guten Standort für Warenlager zu ermitteln.\todo{Problem an den Anfang stellen}
Auch Personen die eine(n) Wohnung/Wohnstandort suchen kann die Anwendung helfen einen geeigneten Standort zu finden, indem man seinen Arbeitsstandort, seine Arztpraxis oder andere wichtige Institutionen einträgt.
Durch die Optimierung kann man Zeit und Geld sparen, da man für kürzere Strecken weniger Treibstoff benötigt und man für diesen bekanntlich Geld bezahlen muss.\todo{Den letzten Halbsatz würde ich umformulieren, "bekanntlich Geld bezahlen muss" klingt etwas informell. Vielleicht "weniger Treibstoff benötigt und damit Geld spart" oder etwas ähnliches.}
\cleardoublepage
